...
struct FBreakingEvent : public FCacheEventBase
{
	...
	FBreakingEvent(int32 InIndex, const Chaos::TBreakingData<float, 3>& InData, const FTransform& WorldToComponent)
		: Index(InIndex)
...
struct FCollisionEvent : public FCacheEventBase
{
	...
	FCollisionEvent(int32 InIndex, const Chaos::TCollisionData<float, 3>& InData, const FTransform& WorldToComponent)
		: Index(InIndex)
		, Location(WorldToComponent.TransformPosition(InData.Location))
...
struct FTrailingEvent : public FCacheEventBase
{
	...
	FTrailingEvent(int32 InIndex, const Chaos::TTrailingData<float, 3>& InData, const FTransform& WorldToComponent)
		: Index(InIndex)
		, Location(WorldToComponent.TransformPosition(InData.Location))
		, Velocity(WorldToComponent.TransformVector(InData.Velocity))
		, AngularVelocity(InData.AngularVelocity)
